...
export interface HygieneInstrumentSnapshot { id: string; category: HygieneInstrumentCategory; instrumentType: string; brand: string; model: string; serialNumber: string; calibrationDate?: string; calibrationExpiry?: string; certificateUrl?: string; capturedAt: string; }
...
export interface HygieneMeasurement { id: string; context: HygieneMeasurementContext; protocolType: string; measurementDate: string; instrumentIds: string[]; instrumentSnapshots?: HygieneInstrumentSnapshot[]; rawData?: Record<string, unknown>; normativeEvaluationSnapshot?: NormativeEvaluationSnapshot; notes?: string; status: HygieneMeasurementStatus; active: boolean; createdBy?: string; createdAt?: string; updatedBy?: string; updatedAt?: string; }
...
export interface CreateHygieneMeasurementInput { context: HygieneMeasurementContext; protocolType: string; measurementDate: string; instrumentIds: string[]; instrumentSnapshots?: HygieneInstrumentSnapshot[]; rawData?: Record<string, unknown>; notes?: string; }
