...
const iperService = `import { dbFirestore } from './firebase';
...
const normativeService = `import { dbFirestore } from './firebase';
...
fs.writeFileSync('src/services/iperService.ts', iperService);
fs.writeFileSync('src/services/normativeService.ts', normativeService);
