  ...
  return <div className="space-y-6">
    ...
    {showWizard && <div className="bg-white dark:bg-slate-900 border border-indigo-200 dark:border-indigo-900 rounded-2xl p-6 shadow-sm">
      ...
      {step === 1 && <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <label className="text-sm font-medium">Empresa<input value={activeCompany?.tradeName || activeCompany?.legalName || context.companyId} disabled className="mt-1 w-full rounded-xl border p-2.5 bg-slate-50 dark:bg-slate-800"/></label>
